...
public final class CustomCachingRecommender implements CustomRecommender {
  
  private static final Logger log = LoggerFactory.getLogger(CustomCachingRecommender.class);
  
  private final CustomRecommender recommender;
  ...
  public CustomCachingRecommender(CustomRecommender recommender) throws TasteException {
