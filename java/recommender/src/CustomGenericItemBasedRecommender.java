...
public class CustomGenericItemBasedRecommender extends CustomAbstractRecommender implements ItemBasedRecommender {

	private static final Logger log = LoggerFactory.getLogger(CustomGenericItemBasedRecommender.class);
	...
	public CustomGenericItemBasedRecommender(DataModel dataModel,
			ItemSimilarity similarity,
			CustomCandidateItemsStrategy candidateItemsStrategy,
	...
	public CustomGenericItemBasedRecommender(DataModel dataModel, ItemSimilarity similarity) {
		this(dataModel,
				similarity,
				CustomAbstractRecommender.getDefaultCandidateItemsStrategy(),
